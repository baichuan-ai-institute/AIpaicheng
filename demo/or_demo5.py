...
# 在第一个子图(ax1)中画图
df_180[1].plot(ax=ax1, label='瞬时流量', xlabel='时间')

# 画一条垂直直线，x=2.5
y1_min, y1_max = ax1.get_ylim()


scheme_dep_to_dem_start_ts = pd.DatetimeIndex(['2023-11-05 07:52:00', '2023-11-05 08:44:00', '2023-11-05 10:24:00',
                                                '2023-11-05 18:02:00',
                                                '2023-11-05 23:09:00'])
scheme_dep_to_dem_end_ts = pd.DatetimeIndex(['2023-11-05 08:42:00','2023-11-05 09:34:00','2023-11-05 11:14:00',
                                              '2023-11-05 18:52:00',
                                             '2023-11-05 23:59:00'])
scheme_dem_to_dep_start_ts = pd.DatetimeIndex(['2023-11-05 09:34:00','2023-11-05 12:18:00','2023-11-05 21:17:00',
                                               '2023-11-05 21:17:00','2023-11-05 22:38:00','2023-11-05 23:58:00',
                                               '2023-11-05 23:59:00'])
scheme_dem_to_dep_end_ts = pd.DatetimeIndex(['2023-11-05 10:24:00','2023-11-05 13:08:00','2023-11-05 22:07:00',
                                             '2023-11-05 22:07:00','2023-11-05 23:09:00','2023-11-06 00:29:00',
                                             '2023-11-06 00:49:00'])
...
real_dep_to_dem_start_ts = pd.DatetimeIndex(['2023-11-05 00:57:00','2023-11-05 08:55:00',
                                             '2023-11-05 12:35:00','2023-11-05 15:35:00',
                                             '2023-11-05 20:40:00'])
real_dep_to_dem_end_ts = pd.DatetimeIndex(['2023-11-05 01:25:00','2023-11-05 09:35:00',
                                           '2023-11-05 13:18:00','2023-11-05 16:15:00',
                                           '2023-11-05 21:08:00'])
real_dem_to_dep_start_ts = pd.DatetimeIndex(['2023-11-05 01:30:00','2023-11-05 09:50:00','2023-11-05 09:55:00',
                                             '2023-11-05 13:25:00','2023-11-05 16:23:00','2023-11-05 16:35:00',
                                             '2023-11-05 21:16:00'])
real_dem_to_dep_end_ts = pd.DatetimeIndex(['2023-11-05 01:55:00','2023-11-05 10:25:00','2023-11-05 10:05:00',
                                           '2023-11-05 14:06:00','2023-11-05 17:10:00','2023-11-05 16:50:00',
                                           '2023-11-05 21:45:00'])

# 在第二个子图(ax2)中画图
df_180[1].plot(ax=ax2, label='瞬时流量', xlabel='时间')
