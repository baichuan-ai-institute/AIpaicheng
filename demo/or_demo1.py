...
for sub_scheme in result['scheme']:
    print('veh_id:', sub_scheme['veh_id'])
    route = []
    timetable = []
    with_tank = []
    for sub_task in sub_scheme['tasks']:
        route += [sub_task['start_node'], sub_task['end_node']]
        timetable += [sub_task['start_time'][11:16], sub_task['end_time'][11:16]]
        with_tank += [sub_task['tank_id']]
    print('route:', route)
    print('timetable:', timetable)
    print('with_tank:', with_tank)
    print()
